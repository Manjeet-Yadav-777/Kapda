...
function Navbar() {
  ...
  useEffect(()=>{
    ...
    const Navitems = (
        <>
            ...
            <li><a href='/Fashion' className='font-[600]'>Fashion</a></li>
            <li><a className='font-[600]'>Cart</a></li>
            <li><a href='/help' className='font-[600]'>Help</a></li>
        </>
    )
  return (
    <div className={`max-w-screen-2xl dark:text-white dark:bg-slate-900 container mx-auto md:px-20 px-4 fixed z-10 top-0 left-0 right-0${
    ...
    <a className="cursor-pointer font-bold text-2xl text-pink-500">Kapda</a>
  </div>
  ...
  <div className="">
    <a className="bg-slate-900 text-white px-5 py-3 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={()=>{document.getElementById("my_modal_3").showModal()}}>Login</a>
  </div>
  <Login/>
  </div>
</div>
